...
public interface VideoService {
    /**
     * @param comment Comment实体，包含信息见实体类
     ...
     * @return java.util.List<com.xiaoxiaobulletscreen.entity.Comment>
     * @author kaciry
     * @description 根据视频文件名查询视频评论
     * @date 2019/10/26 13:57
     **/
    List<Comment> selectVideoCommentsByVideoFilename(String videoFileName);
