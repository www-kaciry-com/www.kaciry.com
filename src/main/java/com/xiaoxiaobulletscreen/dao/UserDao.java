...
public interface UserDao {
     ...
     * @return com.xiaoxiaobulletscreen.entity.User
     * @author kaciry
     ...
     * @return com.xiaoxiaobulletscreen.entity.FansBean
     * @author kaciry
    ...
    /**
     * @param username 用户名
     * @return java.util.List<com.xiaoxiaobulletscreen.entity.FansBean>
     * @author kaciry
     * @description 查询用户关注
    ...
    /**
     * @param username 用户名
     * @return java.util.List<com.xiaoxiaobulletscreen.entity.UnionFansBean>
     * @author kaciry
    ...
    Comment queryCommentByIdentityDocument(int commentIdentityDocument);
}
